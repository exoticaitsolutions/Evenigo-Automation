...
#         titles = titles1[5:10]
#         data.append([image_src, heading1, 'Sale', description, 'Hulu Calendar', 'No', 'Public', ' 0', '', '', NEW_ON_HULU_WEBSITE_URL, ''])
...
#             data.append(['', heading, 'Sale', title.text,  'Hulu Calendar', 'No', 'Public', ' 0', converted_date, End_date, NEW_ON_HULU_WEBSITE_URL, ''])
...
#             converted_date = convert_date(date, year=current_year)
#             End_date = get_next_date(converted_date)
#             data.append(['', desc, 'Sale', '', 'Hulu Calendar', 'No', 'Public', '0', converted_date, End_date, NEW_ON_HULU_WEBSITE_URL, ''])
